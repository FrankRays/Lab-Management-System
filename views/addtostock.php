...
<body>
	...
	<div> 
		<form method="post">
				...
				if(mysqli_num_rows($query_result)>0)
				echo '		
				<table align=center cellspacing="20" cellpadding="1" style="clear:both">
					
					<tr>
						<td>PRNo. :</td>
						<td align=left><input type="text" name="prnoaddtostock"/></td>
						<td><input type="submit" name="selectaddtostock" value=" SELECT "></td>
					</tr>
				</table>'
				?>
		</form>
